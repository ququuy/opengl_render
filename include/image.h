...
GLuint loadHDRTexture2D(const char *filename, int &x, int &y, int &n, GLint minFilter=GL_LINEAR_MIPMAP_NEAREST, GLint magFilter=GL_LINEAR, GLint textureWrapS=GL_REPEAT, GLint textureWrapT=GL_REPEAT);
